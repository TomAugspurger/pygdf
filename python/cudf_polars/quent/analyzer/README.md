...
`../bridge/Cargo.toml` to the same full commit SHA, then refresh and commit both
Cargo lockfiles. See the bridge's [Updating Quent](../bridge/README.md#updating-quent)
section for the complete update and verification checklist.
